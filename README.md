...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rough-field-4ce3
```

A live public deployment of this template is available at [https://rough-field-4ce3.templates.workers.dev](https://rough-field-4ce3.templates.workers.dev)
